...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"new-func.cpp", metadata !"%PATH%/kaldi-new-bug", metadata !"clang version 3.2 (tags/RELEASE_32/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !32} ; [ DW_TAG_compile_unit ] [%PATH%/kaldi-new-bug/new-func.cpp] [DW_LANG_C_plus_plus]
...
!6 = metadata !{i32 786473, metadata !"new-func.cpp", metadata !"%PATH%/kaldi-new-bug", null} ; [ DW_TAG_file_type ]
...
!43 = metadata !{i32 786443, metadata !5, i32 4, i32 0, metadata !6, i32 0} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
...
!60 = metadata !{i32 786443, metadata !12, i32 21, i32 0, metadata !6, i32 1} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
...
!87 = metadata !{i32 786443, metadata !13, i32 36, i32 0, metadata !6, i32 2} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
...
!97 = metadata !{i32 786443, metadata !87, i32 43, i32 0, metadata !6, i32 3} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
...
!107 = metadata !{i32 786443, metadata !18, i32 49, i32 0, metadata !6, i32 4} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
...
!113 = metadata !{i32 786443, metadata !107, i32 52, i32 0, metadata !6, i32 5} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
...
!119 = metadata !{i32 786443, metadata !113, i32 55, i32 0, metadata !6, i32 6} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
!120 = metadata !{i32 57, i32 0, metadata !119, null}
!121 = metadata !{i32 58, i32 0, metadata !122, null}
!122 = metadata !{i32 786443, metadata !113, i32 57, i32 0, metadata !6, i32 7} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
...
!134 = metadata !{i32 786443, metadata !21, i32 66, i32 0, metadata !6, i32 8} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
...
!155 = metadata !{i32 786443, metadata !24, i32 78, i32 0, metadata !6, i32 9} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
...
!167 = metadata !{i32 786443, metadata !155, i32 88, i32 0, metadata !6, i32 10} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
!168 = metadata !{i32 90, i32 0, metadata !169, null}
!169 = metadata !{i32 786443, metadata !167, i32 89, i32 0, metadata !6, i32 11} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
...
!176 = metadata !{i32 786443, metadata !155, i32 98, i32 0, metadata !6, i32 12} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
!177 = metadata !{i32 98, i32 0, metadata !176, null}
!178 = metadata !{i32 99, i32 0, metadata !179, null}
!179 = metadata !{i32 786443, metadata !176, i32 98, i32 0, metadata !6, i32 13} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
...
!185 = metadata !{i32 786443, metadata !186, i32 106, i32 0, metadata !6, i32 15} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
!186 = metadata !{i32 786443, metadata !155, i32 105, i32 0, metadata !6, i32 14} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
!187 = metadata !{i32 106, i32 0, metadata !185, null}
!188 = metadata !{i32 107, i32 0, metadata !189, null}
!189 = metadata !{i32 786443, metadata !185, i32 106, i32 0, metadata !6, i32 16} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
...
!194 = metadata !{i32 786443, metadata !155, i32 112, i32 0, metadata !6, i32 17} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
...
!210 = metadata !{i32 786443, metadata !27, i32 121, i32 0, metadata !6, i32 18} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
...
!218 = metadata !{i32 786443, metadata !210, i32 125, i32 0, metadata !6, i32 19} ; [ DW_TAG_lexical_block ] [%PATH%/kaldi-new-bug/new-func.cpp]
