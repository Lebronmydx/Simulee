...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"new-fun.cpp", metadata !"%PATH%/thundersvm-new-bug", metadata !"clang version 3.2 (tags/RELEASE_32/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !29} ; [ DW_TAG_compile_unit ] [%PATH%/thundersvm-new-bug/new-fun.cpp] [DW_LANG_C_plus_plus]
...
!6 = metadata !{i32 786473, metadata !"new-fun.cpp", metadata !"%PATH%/thundersvm-new-bug", null} ; [ DW_TAG_file_type ]
...
!39 = metadata !{i32 786443, metadata !5, i32 21, i32 0, metadata !6, i32 0} ; [ DW_TAG_lexical_block ] [%PATH%/thundersvm-new-bug/new-fun.cpp]
...
!44 = metadata !{i32 786443, metadata !39, i32 26, i32 0, metadata !6, i32 1} ; [ DW_TAG_lexical_block ] [%PATH%/thundersvm-new-bug/new-fun.cpp]
!45 = metadata !{i32 26, i32 0, metadata !44, null}
!46 = metadata !{i32 27, i32 0, metadata !47, null}
!47 = metadata !{i32 786443, metadata !44, i32 26, i32 0, metadata !6, i32 2} ; [ DW_TAG_lexical_block ] [%PATH%/thundersvm-new-bug/new-fun.cpp]
!48 = metadata !{i32 28, i32 0, metadata !49, null}
!49 = metadata !{i32 786443, metadata !47, i32 27, i32 0, metadata !6, i32 3} ; [ DW_TAG_lexical_block ] [%PATH%/thundersvm-new-bug/new-fun.cpp]
!50 = metadata !{i32 29, i32 0, metadata !51, null}
!51 = metadata !{i32 786443, metadata !49, i32 28, i32 0, metadata !6, i32 4} ; [ DW_TAG_lexical_block ] [%PATH%/thundersvm-new-bug/new-fun.cpp]
...
!77 = metadata !{i32 786443, metadata !14, i32 43, i32 0, metadata !6, i32 5} ; [ DW_TAG_lexical_block ] [%PATH%/thundersvm-new-bug/new-fun.cpp]
...
!107 = metadata !{i32 786443, metadata !77, i32 64, i32 0, metadata !6, i32 6} ; [ DW_TAG_lexical_block ] [%PATH%/thundersvm-new-bug/new-fun.cpp]
...
!128 = metadata !{i32 786443, metadata !107, i32 83, i32 0, metadata !6, i32 7} ; [ DW_TAG_lexical_block ] [%PATH%/thundersvm-new-bug/new-fun.cpp]
!129 = metadata !{i32 85, i32 0, metadata !128, null}
!130 = metadata !{i32 86, i32 0, metadata !131, null}
!131 = metadata !{i32 786443, metadata !128, i32 85, i32 0, metadata !6, i32 8} ; [ DW_TAG_lexical_block ] [%PATH%/thundersvm-new-bug/new-fun.cpp]
...
!136 = metadata !{i32 786443, metadata !107, i32 90, i32 0, metadata !6, i32 9} ; [ DW_TAG_lexical_block ] [%PATH%/thundersvm-new-bug/new-fun.cpp]
...
!143 = metadata !{i32 786443, metadata !107, i32 99, i32 0, metadata !6, i32 10} ; [ DW_TAG_lexical_block ] [%PATH%/thundersvm-new-bug/new-fun.cpp]
...
!175 = metadata !{i32 786443, metadata !28, i32 1, i32 0, metadata !6, i32 14} ; [ DW_TAG_lexical_block ] [%PATH%/thundersvm-new-bug/new-fun.cpp]
...
!183 = metadata !{i32 786443, metadata !25, i32 5, i32 0, metadata !6, i32 13} ; [ DW_TAG_lexical_block ] [%PATH%/thundersvm-new-bug/new-fun.cpp]
...
!189 = metadata !{i32 786443, metadata !24, i32 17, i32 0, metadata !6, i32 12} ; [ DW_TAG_lexical_block ] [%PATH%/thundersvm-new-bug/new-fun.cpp]
...
!194 = metadata !{i32 786443, metadata !20, i32 13, i32 0, metadata !6, i32 11} ; [ DW_TAG_lexical_block ] [%PATH%/thundersvm-new-bug/new-fun.cpp]
